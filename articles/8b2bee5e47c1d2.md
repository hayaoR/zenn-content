...
ある程度メジャーな非純粋関数型言語で代数的データ型を持っている言語はあまり多くはありません。めっちゃいい機能なのにほとんどのメジャー言語で使えないのは非常に残念です。
...
## macro
Rustはmacroが使えます。macroはコードを生み出すコードでコンパイルの際に初期の段階で展開されるため、すごくパワフルなことがいろいろできます。
