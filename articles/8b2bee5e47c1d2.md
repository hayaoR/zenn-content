...
## Rustの特徴
このセクションではRustのおそらくユニークと思われる特徴を紹介します。
...
ある程度メジャーな非純粋関数型言語で代数的データ型を持っている言語はあまり多くはありません。すごくいい機能なのにほとんどのメジャー言語で使えないのは残念です。


### trait

traitは共通の振る舞いを定義する手法です。traitについては以下を御覧ください。
